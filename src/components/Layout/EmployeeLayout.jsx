  ...
  return (
    ...
    >
      ...
      >
        ...
        <List>
          <ListItemButton component={NavLink} to="/employee/dashboard">
            <ListItemIcon>
              <DashboardIcon />
            </ListItemIcon>
          ...
          <ListItemButton onClick={() => setLeaveOpen(!leaveOpen)}>
            ...
            {open && <ListItemText primary="Leaves" />}
          ...
          <Collapse in={leaveOpen}>
            <List component="div" disablePadding>
              ...
              >
                ...
                {open && <ListItemText primary="Apply Leave" />}
              </ListItemButton>
              ...
              >
                ...
                {open && <ListItemText primary="Leave History" />}
              </ListItemButton>
            </List>
          </Collapse>
          <ListItemButton component={NavLink} to="/employee/change-password">
            <ListItemIcon>
              <LockIcon />
            </ListItemIcon>
